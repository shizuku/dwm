...
static const char *fonts[]          = { "Microsoft YaHei UI:size=10" };
static const char dmenufont[]       = "Sorce Code Pro:size=10";
...
//static const char *tags[] = { "一", "二", "三", "四", "五", "六", "七", "捌", "玖" };
...
static const char *scratchpadcmd[] = { "st", "-t", scratchpadname, "-g", "120x34", "-e", "/usr/bin/vim", "/home/shizuku/workspace/notepad.txt" };
